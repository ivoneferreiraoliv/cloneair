...
<head>
    ...
    <title>Detalhes da Acomodação</title>
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.4/css/all.min.css">
    <link rel="stylesheet" href="<?php echo base_url('assets/css/material-kit.css?v=3.0.4'); ?>">
...
<div class="container mt-5">
    <a href="javascript:history.back()" class="btn btn-secondary mb-3"><i class="fas fa-arrow-left"></i> Voltar</a>
            ...
            <?php if (!empty($accommodation)): ?>
                        ...
                        <div id="carouselExampleIndicators" class="carousel slide" data-bs-ride="carousel">
                            <div class="carousel-indicators">
                                <?php if (!empty($accommodation->photos)): ?>
                                    <?php foreach ($accommodation->photos as $index => $photo): ?>
                                ...
                                <?php if (!empty($accommodation->photos)): ?>
                                    <?php foreach ($accommodation->photos as $index => $photo): ?>
                                        <div class="carousel-item <?php echo $index === 0 ? 'active' : ''; ?>">
                                            <img src="<?php echo base_url('uploads/' . htmlspecialchars($photo)); ?>" class="d-block w-100" alt="Slide <?php echo $index + 1; ?>">
                                        </div>
                                    <?php endforeach; ?>
                                <?php else: ?>
                                    <?php
                                    $image_url = !empty($accommodation->photo) ? base_url('uploads/' . htmlspecialchars($accommodation->photo)) : base_url('uploads/default.jpg');
                                    ?>
                                    <div class="carousel-item active">
                                        <img class="d-block w-100" src="<?php echo $image_url; ?>" alt="Imagem padrão">
                                    </div>
                                <?php endif; ?>
                            </div>
                ...
                <div class="row mt-4">
                    <div class="col-md-8">
                        ...
                        <p class="card-description"><?php echo htmlspecialchars($accommodation->description); ?></p>
                        <p><strong>Localização:</strong> <?php echo htmlspecialchars($accommodation->location); ?></p>
                        <p><strong>Preço por noite:</strong> R$ <?php echo number_format($accommodation->price_per_night, 2, ',', '.'); ?></p>
                        <p><strong>Quartos:</strong> <?php echo htmlspecialchars($accommodation->num_rooms); ?></p>
                        <p><strong>Banheiros:</strong> <?php echo htmlspecialchars($accommodation->num_bathrooms); ?></p>
                        <p><strong>Máximo de hóspedes:</strong> <?php echo htmlspecialchars($accommodation->max_guests); ?></p>
                        <div>
                            <?php 
                    ...
                    <div class="col-md-4">
                        <div class="card card-profile">
                            <div class="card-body">
                                ...
                                <form action="<?php echo base_url('reservations/book'); ?>" method="POST">
...
<script src="<?php echo base_url('assets/js/material-kit.js?v=3.0.4'); ?>"></script>
